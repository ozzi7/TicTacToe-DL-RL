...
namespace TicTacToe_DL_RL
{
    public static class Params
    {
        ...
        public static int NOF_CPU_THREADS_GPU_WORKLOAD = 32; // increases also the number of GPU memory used, if GPU used => one extra thread for openCL
        ...
        public static float C_PUCT = 1.0f; // in theory sqrt(2), in practice usually higher (=more exploration) for training
