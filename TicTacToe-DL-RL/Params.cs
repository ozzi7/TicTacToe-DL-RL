...
namespace TicTacToe_DL_RL
{
    public static class Params
    {
        ...
        public static int NOF_CPU_THREADS_GPU_WORKLOAD = 128; // increases also the number of GPU memory used, if GPU used => one extra thread for openCL max 64

        public static int NOF_CPU_THREADS_CPU_WORKLOAD = 1;
        public static int MAX_PENDING_NN_EVALS = 3; // should be lower than sims per move 
        ...
        public static int STOCHASTIC_MOVES_FIRST_X_MOVES = 8;
        ...
        public static int NOF_SIMS_PER_MOVE_TRAINING = 20;
        public static int NOF_SIMS_PER_MOVE_TESTING = 50;
        ...
        public static float C_PUCT = 1.4f; // in theory sqrt(2), in practice usually higher (=more exploration) for training

        public static float MINIMUM_WIN_PERCENTAGE = 50.1f; // new networks must win at least x percent against old
