    ...
    class Trainer
    {
        ...
        public void TrainKeras()
        {
            ...
            while (true)
            {
                ...
                bool newBestFound = CheckPerformanceVsOldNet(currentNN, bestNN, 0.2f);
        ...
        public bool CheckPerformanceVsOldNet(NeuralNetwork newNN, NeuralNetwork oldNN, float noiseWeight)
        {
